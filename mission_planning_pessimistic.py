# Pessimistic approach variant -> path distance is not considered only success probability maximised
...
random.seed(7)
w1 = 0 # weight to normalize the travelling time in cost function
...
while q > 0 :
    ...
    with open("100runs_seq_demo_pessi.txt", "a") as myfile:
